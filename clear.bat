...
echo 	rclone mkdir "%%%%e:/%%%%f/%%%%f"  -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --transfers 20 --checkers 20 --bwlimit 8650k --drive-allow-import-name-change  
echo 	rclone mkdir "%%%%e:/%%%%f/%%%%f"  -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --transfers 20 --checkers 20 --bwlimit 8650k --drive-allow-import-name-change  
echo ^)
echo ^)
