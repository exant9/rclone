...
echo 	rclone mkdir "%%%%e:/%%%%f/%%%%f"  -q --tpslimit 16 --tpslimit-burst 16 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 16 --tpslimit-burst 16 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --transfers 16 --checkers 16 --bwlimit 8650k --drive-allow-import-name-change  
echo 	rclone mkdir "%%%%e:/%%%%f/%%%%f"  -q --tpslimit 16 --tpslimit-burst 16 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 16 --tpslimit-burst 16 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --transfers 16 --checkers 16 --bwlimit 8650k --drive-allow-import-name-change  
echo ^)
echo ^)
