...
REM rclone ls "aaveusdt,shared_with_me:/jY1CJ1hE4P/" --use-mmap --max-backlog 1600000 --transfers 3000000 --checkers 3000000 --tpslimit 999999999999999999 --tpslimit-burst 999999999999999999 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000 --drive-pacer-min-sleep 10ms --no-traverse
