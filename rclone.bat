...
REM rclone ls "aaveusdt,shared_with_me:/jY1CJ1hE4P/" --use-mmap --max-backlog 3000000 --transfers 3000000 --checkers 3000000 --tpslimit 999999999999999999 --tpslimit-burst 999999999999999999 --drive-pacer-min-sleep 10ms --no-traverse
