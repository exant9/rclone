...
for %%u in ("%fldrv:,=" "%") do (
	...
	rclone mkdir "%%e:/%%f"  -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change  
)
)
...
echo rclone cleanup "aaveusdt_sg1:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "renaave50_sg2:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "renaave7_sg3:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "oudhoh0050_sg4:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "nkiux77509_sg5:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "didrhj9036_sg6:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "hjski8292882_sg7:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "jsnwj84738_sg8:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "ffdnsak8272793_sg9:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo rclone cleanup "otipes7948_sg10:/" -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
...
echo     call rclone mkdir %%%%mkpath[%%x%%]%%%% -q --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs  --drive-skip-dangling-shortcuts --retries=2 -q --low-level-retries 2 --timeout 600s --contimeout 3h --delete-during --transfers 12   --bwlimit 8650k --drive-allow-import-name-change 
echo     set /a "x+=1"
echo     GOTO :d121
echo ^)
