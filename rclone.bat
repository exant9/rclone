...
REM  -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --transfers 100 --checkers 100 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h --use-mmap --max-backlog 1600000 --transfers 100 --checkers 100 --bwlimit 8650k --drive-allow-import-name-change  
...
for %%u in ("%fldrv:,=" "%") do (
	...
	rclone mkdir "%%e:/%%f/%%f"  -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --transfers 100 --checkers 100 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h --use-mmap --max-backlog 1600000 --transfers 100 --checkers 100 --bwlimit 8650k --drive-allow-import-name-change  
)
)
...
REM  docs
echo     call rclone copy "%%%%selofldrs[%%x%%]%%%%,shared_with_me:/jY1CJ1hE4P" "%%%%selofldrs[%%x%%]%%%%_sgdump1a:/" --drive-keep-revision-forever --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h --use-mmap --max-backlog 1600000 --transfers 100 --checkers 100 --bwlimit 8650k --drive-allow-import-name-change --drive-acknowledge-abuse --drive-stop-on-upload-limit --drive-stop-on-download-limit --ignore-size --max-transfer 740G --create-empty-src-dirs --cutoff-mode=CAUTIOUS --drive-copy-shortcut-content --track-renames --drive-pacer-min-sleep 10ms --no-traverse --include "*.{pptx,docx,html,txt,json,xlsx,xls,doc,ppt,rtf,dot,dotm,docb,wll,pdf,wbk,wwl,doc,docm,dotx,htm,mht,mhtml,odt,pdf,rtf,txt,wps,xml,xml,xps,csv,dbf,dif,ods,prn,slk,xla,xlam,xlsb,xls,xlsm,xlt,xltm,xltx,xlw,xml,xps,bmp,emf,gif,odp,pdf,pot,potm,potx,ppa,ppam,pps,ppsm,ppsx,pptm,rtf,thmx,tif,wmf,xml,xps}"
...
REM rclone ls "aaveusdt,shared_with_me:/jY1CJ1hE4P/" --use-mmap --max-backlog 1600000 --transfers 10000000 --checkers 10000000 --tpslimit 999999999999999999 --tpslimit-burst 999999999999999999  --use-mmap --max-backlog 1600000 --drive-pacer-min-sleep 10ms --no-traverse
