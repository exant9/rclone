...
for %%u in ("%fldrv:,=" "%") do (
	...
	rclone mkdir "%%e:/%%f/%%f"  -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000   --transfers 18 --checkers 18 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 1600000 --transfers 18 --checkers 18 --bwlimit 8650k --drive-allow-import-name-change  
)
)
...
echo     call rclone sync "%%%%cacafldrs[%%x%%]%%%%,shared_with_me:/jY1CJ1hE4P/laptop_caca/" "%%%%cacafldrs[%%x%%]%%%%_sg%sg%:/Caca/Caca/calista_ar/Computers/laptop_caca/%%copyname%%/" --min-age 300y --min-size 6000G --drive-keep-revision-forever --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 1600000 --transfers 18 --checkers 18 --bwlimit 8650k --drive-allow-import-name-change --drive-acknowledge-abuse --drive-stop-on-upload-limit --drive-stop-on-download-limit --ignore-size --max-transfer 740G --create-empty-src-dirs --cutoff-mode=CAUTIOUS --drive-copy-shortcut-content --track-renames  --drive-pacer-min-sleep 10ms --no-traverse
echo     set /a "x+=1"
echo     GOTO :r3r34t4^)
...
echo rclone moveto "%acc%_sg%sg%:/Caca/Caca/calista_ar/Computers/laptop_caca/%%copyname%%" "%acc%_sg%sg%:/Caca/Caca/calista_ar/Computers/laptop_caca/%%copyname%%_fix" -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000  --max-duration 22h --low-level-retries 9999999999 --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 1600000 --transfers 18 --checkers 18 --bwlimit 8650k --drive-allow-import-name-change -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000  --max-duration 22h --low-level-retries 9999999999 --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 1600000 --transfers 18 --checkers 18 --bwlimit 8650k --drive-allow-import-name-change 
...
echo rclone sync "%acc%_sgdump%from%:/" "%acc%_sgdump%to%:/" --min-age 300y --min-size 6000G --drive-skip-shortcuts --drive-skip-dangling-shortcuts --drive-skip-dangling-shortcuts --drive-keep-revision-forever --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 1600000 --transfers 18 --checkers 18 --bwlimit 8650k --drive-allow-import-name-change --drive-acknowledge-abuse --drive-stop-on-upload-limit --drive-stop-on-download-limit --ignore-size --max-transfer 740G --create-empty-src-dirs --cutoff-mode=CAUTIOUS --track-renames  --drive-pacer-min-sleep 10ms --no-traverse
...
REM rclone ls "aaveusdt,shared_with_me:/jY1CJ1hE4P/" --use-mmap --max-backlog 1600000 --transfers 1800000 --checkers 1800000 --tpslimit 999999999999999999 --tpslimit-burst 999999999999999999 --drive-pacer-burst 200 --use-mmap --max-backlog 1600000 --drive-pacer-min-sleep 10ms --no-traverse
