...
for %%u in ("%fldrv:,=" "%") do (
	...
	rclone mkdir "%%e:/%%f/%%f"  -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --transfers 30 --checkers 30 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h --use-mmap --max-backlog 1600000 --transfers 30 --checkers 30 --bwlimit 8650k --drive-allow-import-name-change  
)
)
...
REM rclone ls "aaveusdt,shared_with_me:/jY1CJ1hE4P/" --use-mmap --max-backlog 1600000 --transfers 3000000 --checkers 3000000 --tpslimit 999999999999999999 --tpslimit-burst 999999999999999999  --use-mmap --max-backlog 1600000 --drive-pacer-min-sleep 10ms --no-traverse
