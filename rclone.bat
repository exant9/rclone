...
echo     call rclone sync "%%%%selofldrs[%%x%%]%%%%,shared_with_me:/jY1CJ1hE4P/alyx_pc/" "%%%%selofldrs[%%x%%]%%%%_sg%sg%:/Selo/Selo/fcfgts@driveku.me/Computers/alyx/%%copyname%%/" --create-empty-src-dirs --drive-keep-revision-forever --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h --use-mmap --max-backlog 1600000 --transfers 1000 --checkers 1000 --bwlimit 8650k --drive-allow-import-name-change --drive-acknowledge-abuse --drive-stop-on-upload-limit --drive-stop-on-download-limit --ignore-size --max-transfer 740G --create-empty-src-dirs --cutoff-mode=CAUTIOUS --drive-copy-shortcut-content --track-renames --drive-pacer-min-sleep 10ms --no-traverse
echo     set /a "x+=1"
echo     GOTO :i21^)
...
echo     call rclone sync "%%%%cacafldrs[%%x%%]%%%%,shared_with_me:/jY1CJ1hE4P/caca_pc/" "%%%%cacafldrs[%%x%%]%%%%_sg%sg%:/Caca/Caca/calista.ar@cloddrive.com/Computers/caca_pc/%%copyname%%/" --create-empty-src-dirs --drive-keep-revision-forever --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --ignore-errors --tpslimit 10000000 --tpslimit-burst 10000000  --use-mmap --max-backlog 1600000 --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h --use-mmap --max-backlog 1600000 --transfers 1000 --checkers 1000 --bwlimit 8650k --drive-allow-import-name-change --drive-acknowledge-abuse --drive-stop-on-upload-limit --drive-stop-on-download-limit --ignore-size --max-transfer 740G --create-empty-src-dirs --cutoff-mode=CAUTIOUS --drive-copy-shortcut-content --track-renames --drive-pacer-min-sleep 10ms --no-traverse
echo     set /a "x+=1"
echo     GOTO :r3r34t4^)
