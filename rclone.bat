...
for %%u in ("%fldrv:,=" "%") do (
	...
	rclone mkdir "%%e:/%%f/%%f"  -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000   --transfers 30 --checkers 30 --max-duration 22h --low-level-retries 9999999999 --auto-confirm --no-traverse --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 3000000 --transfers 30 --checkers 30 --bwlimit 8650k --drive-allow-import-name-change  
)
)
...
echo rclone moveto "%acc%_sg%sg%:/Selo/Selo/fcfgts@driveku.me/Computers/alyx/%%copyname%%" "%acc%_sg%sg%:/Selo/Selo/fcfgts@driveku.me/Computers/alyx/%%copyname%%_fix" -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000  --max-duration 22h --low-level-retries 9999999999 --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 3000000 --transfers 30 --checkers 30 --bwlimit 8650k --drive-allow-import-name-change -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000  --max-duration 22h --low-level-retries 9999999999 --auto-confirm --drive-server-side-across-configs --drive-skip-dangling-shortcuts --retries=2 -q --tpslimit 20 --tpslimit-burst 20 --drive-pacer-burst 200 --use-mmap --max-backlog 3000000  --max-duration 22h --low-level-retries 2 --timeout 600s --contimeout 999h  --use-mmap --max-backlog 3000000 --transfers 30 --checkers 30 --bwlimit 8650k --drive-allow-import-name-change 
